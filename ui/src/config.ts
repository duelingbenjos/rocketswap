...
const CURRENCY_NAME = 'Lamden TAU'
...
const BLOCKEXPLORER_URL = 'https://arko.tauhq.com'
const MASTERNODE_URL = 'https://arko-mn-3.lamden.io'
...
export const connectionRequest = {
  appName: 'Rocketswap v2 - ARKO Mainnet',
  version: '1.0.0',
