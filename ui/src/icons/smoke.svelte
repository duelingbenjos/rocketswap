...
<div bind:this={smoke} 
    class:smokeTrail-down={smokeTrail && direction === "down"} 
    class:smokeTrail-left={smokeTrail && direction === "left"} 
    class:smoke={!smokeTrail} 
    class:move 
