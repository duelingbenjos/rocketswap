...
var app = (function () {
    ...
    /** Token Select Logic */
    const show_token_select_store = writable(true);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button1, "click", /*openTokenSelect*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ show_token_select_store, openTokenSelect });
    	return [openTokenSelect];
    }
    ...
    */
    ...
    /* src/components/dimmer.svelte generated by Svelte v3.29.7 */
    const file$6 = "src/components/dimmer.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "dimmer-wrapper svelte-1vmavsq");
    			add_location(div, file$6, 3, 0, 71);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Dimmer> was created with unknown prop '${key}'`);
    	});
    ...
    class Dimmer extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/components/token-select.svelte generated by Svelte v3.29.7 */

    const { console: console_1 } = globals;
    const file$7 = "src/components/token-select.svelte";
    ...
    // (34:6) {#each token_list as token}
    function create_each_block(ctx) {
    	let div;
    	let span0;
    	let t0_value = /*token*/ ctx[3].token_symbol.toUpperCase() + "";
    	let t0;
    	let t1;
    	let span1;
    	...
    	const block = {
    		c: function create() {
    			...
    			span1 = element("span");
    			span1.textContent = "0 ";
    			attr_dev(span0, "class", "token-symbol svelte-1ijf84x");
    			add_location(span0, file$7, 34, 37, 950);
    			attr_dev(span1, "class", "token-amount svelte-1ijf84x");
    			add_location(span1, file$7, 34, 108, 1021);
    			attr_dev(div, "class", "token-container svelte-1ijf84x");
    			add_location(div, file$7, 34, 8, 921);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*token_list*/ 1 && t0_value !== (t0_value = /*token*/ ctx[3].token_symbol.toUpperCase() + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(34:6) {#each token_list as token}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*token_list*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			span = element("span");
    			span.textContent = "Select a token";
    			t1 = space();
    			button = element("button");
    			img = element("img");
    			t2 = space();
    			div1 = element("div");
    			div1.textContent = "Token Name";
    			t4 = space();
    			hr = element("hr");
    			t5 = space();
    			div3 = element("div");
    			...
    			add_location(span, file$7, 22, 4, 601);
    			if (img.src !== (img_src_value = "assets/images/cancel.svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$7, 26, 6, 700);
    			attr_dev(button, "class", "nostyle");
    			add_location(button, file$7, 23, 4, 635);
    			attr_dev(div0, "class", "heading svelte-1ijf84x");
    			add_location(div0, file$7, 21, 2, 575);
    			attr_dev(div1, "class", "select-heading svelte-1ijf84x");
    			add_location(div1, file$7, 29, 2, 767);
    			attr_dev(hr, "class", "svelte-1ijf84x");
    			add_location(hr, file$7, 30, 2, 814);
    			attr_dev(div2, "class", "token-list svelte-1ijf84x");
    			add_location(div2, file$7, 32, 4, 854);
    			attr_dev(div3, "class", "token-scroll svelte-1ijf84x");
    			add_location(div3, file$7, 31, 2, 823);
    			attr_dev(div4, "class", "token-select-wrapper svelte-1ijf84x");
    			add_location(div4, file$7, 20, 0, 496);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*closeModal*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*token_list*/ 1) {
    				each_value = /*token_list*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Token_select", slots, []);
    	...
    	onMount(() => {
    		token_list_unsub = token_list_store.subscribe(update => {
    			$$invalidate(0, token_list = update);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Token_select> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("token_list_unsub" in $$props) token_list_unsub = $$props.token_list_unsub;
    		if ("token_list" in $$props) $$invalidate(0, token_list = $$props.token_list);
    	};
    	...
    	return [token_list, closeModal];
    }

    class Token_select extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$8 = "src/app.container.svelte";

    // (28:2) {#if show_token_select}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			create_component(dimmer.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(dimmer, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(dimmer.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(dimmer.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(dimmer, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(28:2) {#if show_token_select}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	let tokenselect;
    	let current;
    	tokenselect = new Token_select({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(tokenselect.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(tokenselect, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(tokenselect.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(tokenselect.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(tokenselect, detaching);
    		}
    	};
    ...
    function create_fragment$8(ctx) {
    	...
    	let if_block = /*show_token_select*/ ctx[0] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 21, 4, 718);
    			attr_dev(div1, "class", "bg-solid svelte-1le0dwb");
    			add_location(div1, file$8, 20, 2, 691);
    			attr_dev(main, "class", "svelte-1le0dwb");
    			add_location(main, file$8, 19, 0, 682);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*show_token_select*/ ctx[0]) {
    				if (if_block) {
    					if (dirty & /*show_token_select*/ 1) {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		show_token_select_store.subscribe(update => {
    			$$invalidate(0, show_token_select = update);
    		});
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("show_token_select" in $$props) $$invalidate(0, show_token_select = $$props.show_token_select);
    	};
