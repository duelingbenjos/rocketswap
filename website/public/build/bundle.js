    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$3, 88, 3, 2652);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "width", /*width*/ ctx[0]);
    			attr_dev(svg, "viewBox", "0 0 188.821 25.389");
    			add_location(svg, file$3, 83, 2, 2559);
    			set_style(a, "padding-top", "20px");
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "href", "http://45.63.40.194:5000/");
    			add_location(a, file$3, 94, 2, 7787);
    			...
    			add_location(canvas, file$3, 96, 1, 7887);
    			set_style(div1, "position", "absolute");
    			set_style(div1, "bottom", "40px");
    			set_style(div1, "right", "100px");
    			add_location(div1, file$3, 100, 1, 7986);
    			attr_dev(main, "class", "svelte-cnpd82");
