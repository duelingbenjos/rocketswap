...
const cors_whitelist = ['https://lamden.io', 'https://www.onlyluck.net', 'https://rocketswap.exchange', 'https://taurusnft.art', 'http://localhost', 'localhost', 'http//localhost:5001', '0.0.0.0']
