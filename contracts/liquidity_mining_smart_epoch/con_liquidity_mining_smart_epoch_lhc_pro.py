...
LIQUIDITY_TOKEN = "con_collider_contract"  # TAU/RSWP Pair
YIELD_TOKEN = con_proton_contract
...
def seed():
    ...
    Epochs[0] = {"time": now, "staked": 0, "amt_per_hr": 5846}

    meta["version"] = "0.4"
    meta["type"] = "liquidity_mining_smart_epoch"  # staking || lp_farming
    meta["STAKING_TOKEN"] = "con_collider_contract"
    meta["YIELD_TOKEN"] = "con_proton_contract"

    EmissionRatePerHour.set(5846)  # 1200000 RSWP per year = 10% of supply
    DevRewardPct.set(1 / 10)

    # The datetime from which you want to allow staking.
    StartTime.set(datetime.datetime(year=2021, month=7, day=24, hour=22))
    # The datetime at which you want staking to finish.
    EndTime.set(datetime.datetime(year=2022, month=7, day=24, hour=22))
