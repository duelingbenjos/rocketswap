...
LIQUIDITY_TOKEN = "con_proton_contract"
...
def seed():
    ...
    Epochs[0] = {"time": now, "staked": 0, "amt_per_hr": 361}
    EmissionRatePerHour.set(361) # 11507 / 24 * 0.8
    ...
    StartTime.set(datetime.datetime(year=2021, month=8, day=7, hour=23))
    EndTime.set(datetime.datetime(year=2022, month=7, day=24, hour=23))
