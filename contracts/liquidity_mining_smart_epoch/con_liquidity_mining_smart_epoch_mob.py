...
LIQUIDITY_TOKEN = "con_mintorburn"  # TAU/RSWP Pair
YIELD_TOKEN = con_mintorburn
...
def seed():
    ...
    DevRewardWallet.set("ff61544ea94eaaeb5df08ed863c4a938e9129aba6ceee5f31b6681bdede11b89")
    ...
    Epochs[0] = {"time": now, "staked": 0, "amt_per_hr": 158730}

    meta["version"] = "0.4"
    meta["type"] = "liquidity_mining_smart_epoch"  # staking || lp_farming
    meta["STAKING_TOKEN"] = "con_mintorburn"
    meta["YIELD_TOKEN"] = "con_mintorburn"

    EmissionRatePerHour.set(158730)  # 1200000 RSWP per year = 10% of supply
    DevRewardPct.set(1/10)

    # The datetime from which you want to allow staking.
    StartTime.set(datetime.datetime(year=2021, month=11, day=16, hour=13))
    # The datetime at which you want staking to finish.
    EndTime.set(datetime.datetime(year=2022, month=6, day=16, hour=13))
