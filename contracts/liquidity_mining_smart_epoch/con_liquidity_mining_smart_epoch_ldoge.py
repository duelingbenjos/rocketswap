...
LIQUIDITY_TOKEN = "con_lambdoge"  # TAU/RSWP Pair
...
def seed():
    ...
    Epochs[0] = {"time": now, "staked": 0, "amt_per_hr": 20578231}

    meta["version"] = "0.4"
    meta["type"] = "liquidity_mining_smart_epoch"  # staking || lp_farming
    meta["STAKING_TOKEN"] = "con_lambdoge"
    meta["YIELD_TOKEN"] = "con_lambdoge"

    EmissionRatePerHour.set(20578231)  # 1200000 RSWP per year = 10% of supply
    DevRewardPct.set(0)
