...
LIQUIDITY_TOKEN = "con_weth_lst001"  # TAU/RSWP Pair
YIELD_TOKEN = currency
...
def seed():
    ...
    EpochMaxRatioIncrease.set(10000000)
    EpochMinTime.set(10000000)
    TrustedImporters.set([])

    Epochs[0] = {"time": now, "staked": 0, "amt_per_hr": 2283.105022831050228}

    meta["version"] = "0.3"
    meta["type"] = "liquidity_mining_smart_epoch"  # staking || lp_farming
    meta["STAKING_TOKEN"] = "con_weth_lst001"
    meta["YIELD_TOKEN"] = "currency"

    EmissionRatePerHour.set(2283.105022831050228)  # 1200000 GOLD per year = 10% of supply
    DevRewardPct.set(1/10)

    # The datetime from which you want to allow staking.
    StartTime.set(datetime.datetime(year=2021, month=6, day=19, hour=22))
    # The datetime at which you want staking to finish.
    EndTime.set(datetime.datetime(year=2022, month=9, day=19, hour=22))
