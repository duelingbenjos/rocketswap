...
def seed():
    ...
    EpochMaxRatioIncrease.set(10000)
    EpochMinTime.set(10000)

    Epochs[0] = {"time": now, "staked": 0, "amt_per_hr": 46685}
    ...
    EmissionRatePerHour.set(46685)  # 1200000 RSWP per year = 10% of supply
...
def recoverYieldToken():
    ...
    amount_to_recover = total_available
