...
def seed():
    ...
    Epochs[0] = {"time": now, "staked": 0, "amt_per_hr": 3506}
    ...
    EmissionRatePerHour.set(3506)  # 1200000 RSWP per year = 10% of supply
    DevRewardPct.set(1 / 10)

    # The datetime from which you want to allow staking.
    StartTime.set(datetime.datetime(year=2021, month=7, day=30, hour=22))
    # The datetime at which you want staking to finish.
    EndTime.set(datetime.datetime(year=2022, month=5, day=5, hour=22))
